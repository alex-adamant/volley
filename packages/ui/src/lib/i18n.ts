...
const ru: Record<string, string> = {
  ...
  "Boosted (x2)": "С бустом (x2)",
  "No boost (x1)": "Без буста (x1)",
  ...
  Upsets: "Апсеты",
  "Extreme matches": "Экстремальные матчи",
  ...
  "Top-10 safest wins": "Топ-10 самых ожидаемых побед",
  "Top-10 biggest wins by margin": "Топ-10 крупнейших побед по разнице мячей",
  ...
  "No favorite wins yet.": "Побед фаворитов пока нет.",
